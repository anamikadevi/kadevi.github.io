...
**If dashboard is not in correct format, rebuild website or use direct command rmarkdown::render("dashboard_template.Rmd", output_format = "flexdashboard::flex_dashboard")
